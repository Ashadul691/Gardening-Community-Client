...
const Navbar = () => {
  ...
  const navItems = [
    ...
    { to: '/gardeners', label: 'Explore Gardeners', icon: Users },
    { to: '/tips', label: 'Browse Tips', icon: FileText },
  ];

  if (user) {
    navItems.push(
      { to: '/share-tip', label: 'Share Tip', icon: FileText },
      { to: '/my-tips', label: 'My Tips', icon: UserCircle }
    );
  }
